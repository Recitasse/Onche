...
function plugged($val) {
    if ($val == FALSE) {
        echo '<a href="connexion.php" style="color: black; text-decoration: none;" title="Se connecter à MySQL"><img class="plug" src="images/icon/unplugged.png" alt="déco" style="height: 3em; vertical-align: middle; position: absolute; left: 0;"></a>';
    }
    else {
        echo '<a href="connexion.php" style="color: black; text-decoration: none;" title="Se déconnecter de MySQL"><img class="plug" src="images/icon/plugged.png" alt="déco" style="height: 3em; vertical-align: middle; position: absolute; left: 0;"></a>';
    }
}
