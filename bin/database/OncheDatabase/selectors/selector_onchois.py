"""
==================================================
Python class OnchoisBdd générée par OncheQueryGenerator BDD TOOLS GENERATOR
Author: recitasse
Model: Onche	 Version: 0.8.3
Made by Recitasse 2024-06-13 20:34:24.347119
==================================================
"""
...
from ..entities.Onchois import Onchois
...
class OnchoisBdd(Link):
    ...
    def add_onchois(self, oid: int, ban: int, niveau: int, nom: str, message: int, date: datetime) -> None:
        query = 'INSERT INTO onchois (onchois_oid, onchois_ban, onchois_niveau, onchois_nom, onchois_message, onchois_date);'
        params = (oid, ban, niveau, nom, message, date,)
