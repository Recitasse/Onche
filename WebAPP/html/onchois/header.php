                ...
                <ul class="horizontal-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="../connexion/base_de_donnee.php">Base de donnée 💾</a></li>
                            <li><a href="../connexion/informations.php">Informations ℹ️</a></li>
                            <li><a href="../connexion/aide.php">Aide ♿</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
